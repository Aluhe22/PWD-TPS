...
<div class="modal fade" id="ModalForm" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
        <!-- Login Form -->
        <form id="from_login" name="from_login" method="post" action="ejercicio_3_resultado.php">
        <div class="modal-header">
          ...
          <div class="modal-body">
            <div class="mb-3">
                ...
                <input type="text" name="usuario" class="form-control" id="Username" placeholder="Enter Username">
            </div>
