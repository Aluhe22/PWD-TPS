...
<h2>Ejercicio 4</h2>
    <form class="needs-validation" novalidate id="from_datos" name="from_datos" method="get" action="ejercicio_4_resultado.php">
        <div class="mb-3">
...
<script src="../assets/js/tp1/ejercicio_4.js"></script>
</div>
</div>
<?php
