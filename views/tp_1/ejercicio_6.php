...
<h2>Ejercicio 6</h2>
    <form class="row" id="from_datos" name="from_datos" method="get" action="ejercicio_6_resultado.php">
        <div class="mb-3">
        ...
        <select name="deporte[]" class="selectpicker" multiple data-live-search="true">
